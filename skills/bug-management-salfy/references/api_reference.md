...
```json
{
  ...
  "createdBy": "user123",
  "url": "https://your-test-env.example.com/issues/PROJ-12345"
}
```
...
BASE_URL = "https://your-test-env.example.com/api"
USERNAME = "your-username"
PASSWORD = "your-password"
...
出于当前技能的安全约束，本技能文档不再提供 shell 或 cURL 形式的调用示例。
如需集成，请优先参考本节的 Python 示例，并通过环境变量注入测试环境凭据与地址。
