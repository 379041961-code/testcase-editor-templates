...
class AliyunCloudEffectAutomation:
    ...
    def _load_config(self, config_path):
        ...
        if Path(config_path).exists():
            with open(config_path, 'r', encoding='utf-8') as f:
                return json.load(f)
        return {"cloudEffect": {"baseUrl": "https://account.aliyun.com"}}
    ...
    def login(self):
        ...
        try:
            ...
            login_url = "https://account.aliyun.com/login/login.htm?oauth_callback=https%3A%2F%2Faccount-devops.aliyun.com%2Flogin%3Fnext_url%3Dhttp%3A%2F%2Faccount-devops.aliyun.com%2Flogin%3Fnext_url%3Dhttps%3A%2F%2Fdevops.aliyun.com%2Fworkbench%3ForgId%3D66f3cf41a586935aae39d156"
    ...
    def assign_bug(self, assignee_name_or_email):
        ...
        Args:
            assignee_name_or_email: 负责人邮箱或姓名（如 liu.ting@alibaba-inc.com 或 刘庭）
        """
        try:
...
def main():
    ...
    try:
        ...
        # 指派负责人
        if not automation.assign_bug('liu.ting@alibaba-inc.com'):
            print("指派失败")
            return
